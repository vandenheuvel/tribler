...
class TestTriblerChainCommunity(BaseTestTrustChainCommunity):
    ...
    def test_get_graph_no_edges(self):
        ...
        actual_nodes, actual_edges = node.community.get_graph(public_key="aa")
    ...
    def test_get_graph(self):
        ...
        expected_nodes = [
            ...
            {"public_key": "ee", "total_up": 4, "total_down": 4, "total_neighbors": 1, "score": 0.5},
            {"public_key": "ff", "total_up": 5, "total_down": 5, "total_neighbors": 1, "score": 0.5}
        ]
        expected_edges = [
            ...
            {"from": "bb", "to": "ee", "amount": 0},
            {"from": "ee", "to": "bb", "amount": 0},
            {"from": "bb", "to": "ff", "amount": 0},
            {"from": "ff", "to": "bb", "amount": 0},
        ]

        actual_nodes, actual_edges = node.community.get_graph(public_key="aa", neighbor_level=2, max_neighbors=2)
